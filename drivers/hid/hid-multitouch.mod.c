...
__attribute__((section("__versions"))) = {
	...
	{ 0x3679fa5d, __VMLINUX_SYMBOL_STR(input_mt_get_slot_by_key) },
	{ 0x40c4e58, __VMLINUX_SYMBOL_STR(input_mt_sync_frame) },
	...
	{ 0xb1e41304, __VMLINUX_SYMBOL_STR(hidinput_calc_abs_res) },
...
MODULE_INFO(srcversion, "4362CF0973C8B7DFD4C91F3");
