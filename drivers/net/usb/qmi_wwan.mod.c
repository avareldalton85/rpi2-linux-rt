...
__attribute__((section("__versions"))) = {
	...
	{ 0x5c8263bf, __VMLINUX_SYMBOL_STR(eth_commit_mac_addr_change) },
	{ 0x2d5ba51a, __VMLINUX_SYMBOL_STR(eth_prepare_mac_addr_change) },
...
MODULE_INFO(srcversion, "4CCDE2A162C3C0937C43B98");
