...
__attribute__((section("__versions"))) = {
	...
	{ 0x54384e5e, __VMLINUX_SYMBOL_STR(usb_wwan_chars_in_buffer) },
	{ 0x506ebc43, __VMLINUX_SYMBOL_STR(usb_wwan_write_room) },
...
MODULE_INFO(srcversion, "4C8ABA0286DD2C268DE80DF");
