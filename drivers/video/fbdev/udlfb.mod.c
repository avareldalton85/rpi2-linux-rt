...
__attribute__((section("__versions"))) = {
	...
	{ 0x5c391104, __VMLINUX_SYMBOL_STR(device_create_bin_file) },
	...
	{ 0x6685feff, __VMLINUX_SYMBOL_STR(unlink_framebuffer) },
	{ 0x17511af0, __VMLINUX_SYMBOL_STR(device_remove_bin_file) },
...
MODULE_INFO(srcversion, "EAB634E7776859120AB99EB");
