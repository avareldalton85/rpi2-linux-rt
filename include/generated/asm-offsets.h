...
#define TI_EXEC_DOMAIN 20 /* offsetof(struct thread_info, exec_domain)	@ */
#define TI_CPU 24 /* offsetof(struct thread_info, cpu)	@ */
#define TI_CPU_DOMAIN 28 /* offsetof(struct thread_info, cpu_domain)	@ */
#define TI_CPU_SAVE 32 /* offsetof(struct thread_info, cpu_context)	@ */
#define TI_USED_CP 84 /* offsetof(struct thread_info, used_cp)	@ */
#define TI_TP_VALUE 100 /* offsetof(struct thread_info, tp_value)	@ */
#define TI_FPSTATE 112 /* offsetof(struct thread_info, fpstate)	@ */
